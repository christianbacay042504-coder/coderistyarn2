...
$assignedGuide = initializeAssignedGuide('Paradise Hill Farm');
...
if (isset($_GET['action']) && $_GET['action'] === 'book') {
    $destination = $_GET['destination'] ?? 'Paradise Hill Farm';
    ...
    <style>
        ...
        .spot-hero {
            ...
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.5)), 
                       url('https://images.unsplash.com/photo-1605000797499-95a51c5269ae?q=80&w=2070&auto=format&fit=crop');
...
<body>
    ...
    <section class="spot-hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">A Sustainable Agricultural Paradise and Learning Center</p>
        </div>
    </section>
        ...
        <div class="spot-content">
            <div class="spot-details">
                ...
                <div>
                    ...
                    <p class="description">
                        Paradise Hill Farm is a premier agricultural destination in San Jose del Monte that combines 
                        sustainable farming practices with educational tourism. This sprawling farm offers visitors 
                        a hands-on experience with modern agriculture, organic farming techniques, and farm-to-table 
                        concepts, making it perfect for families, students, and agriculture enthusiasts.
                    </p>
                    
                    <h3 class="section-subtitle">Farm Features & Activities</h3>
                    <ul class="features-list">
                        <li><strong>Organic Vegetable Gardens:</strong> Extensive plots growing various organic vegetables</li>
                        <li><strong>Hydroponic Systems:</strong> Modern soil-less farming demonstrations</li>
                        <li><strong>Animal Encounters:</strong> Interactive farm animal experience area</li>
                        <li><strong>Farm-to-Table Restaurant:</strong> Fresh meals using farm-grown ingredients</li>
                        <li><strong>Educational Tours:</strong> Guided tours explaining sustainable agriculture</li>
                        <li><strong>Workshops & Training:</strong> Regular farming and gardening workshops</li>
                        <li><strong>Harvest Experience:</strong> Seasonal fruit and vegetable picking activities</li>
                    </ul>
                    ...
                    <div class="photo-gallery">
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1605000797499-95a51c5269ae?q=80&w=2070&auto=format&fit=crop" alt="Farm Landscape">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?q=80&w=2070&auto=format&fit=crop" alt="Vegetable Garden">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=2070&auto=format&fit=crop" alt="Farm Animals">
                        </div>
                    </div>
                </div>
                ...
                <div class="spot-info-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">8:00 AM - 5:00 PM Daily</span>
                            </div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">SJDM Agricultural Zone</span>
                            </div>
                        </div>
                    </div>

                    <h3 class="section-subtitle">Package Options</h3>
                    <ul style="margin: 15px 0; padding-left: 20px; color: var(--text-light); font-size: 0.95rem;">
                        <li><strong>Basic Tour:</strong> ₱150 - Farm tour and animal encounters</li>
                        <li><strong>Farm Experience:</strong> ₱300 - Includes harvest activities</li>
                        <li><strong>Full Day Package:</strong> ₱500 - Tour, lunch, and workshop</li>
                        <li><strong>Group Rate:</strong> 20% discount for 10+ persons</li>
                    </ul>
                    ...
                    <ul style="margin: 15px 0; padding-left: 20px; color: var(--text-light); font-size: 0.95rem;">
                        ...
                        <li>Extra clothes for children</li>
                        <li>Camera for farm activities</li>
                        <li>Reusable bags for harvest items</li>
                    </ul>
                    ...
                    <button class="btn-primary" onclick="checkAuth('Paradise Hill Farm'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)" style="width: 100%; margin-top: 25px; color: var(--secondary); background-color: var(--primary);">
            ...
            <div class="cta-section">
                <h2 class="cta-title">Experience Farm Life Up Close</h2>
                <p class="cta-text">
                    Discover the wonders of sustainable agriculture at Paradise Hill Farm. 
                    Perfect for educational trips, family outings, and anyone interested in modern farming practices.
                </p>
                <div class="cta-buttons">
                    <button class="btn-primary" onclick="checkAuth('Paradise Hill Farm'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)">
