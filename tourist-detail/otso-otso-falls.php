...
$assignedGuide = initializeAssignedGuide('Otso-Otso Falls');
...
<head>
    ...
    <style>
        ...
        .features-list li { padding: 12px 0; padding-left: 35px; position: relative; font-size: 1rem; line-height: 1.6; color: var(--text-light); }
        ...
        .safety-notice { background: #fff8e1; border-left: 4px solid #ff9800; padding: 20px; border-radius: 8px; margin: 25px 0; }
        .difficulty-indicator { background: #f5f5f5; padding: 20px; border-radius: 10px; margin: 25px 0; }
        ...
        @media (max-width: 992px) { .spot-details { grid-template-columns: 1fr; gap: 40px; } .spot-info-card { position: static; } .hero-title { font-size: 2.5rem; } }
        @media (max-width: 768px) { .hero-title { font-size: 2rem; } .hero-subtitle { font-size: 1rem; } .photo-gallery { grid-template-columns: 1fr; } .cta-buttons { flex-direction: column; align-items: center; } .btn-primary, .btn-secondary { width: 100%; max-width: 300px; } .header-content { flex-direction: column; gap: 15px; text-align: center; } }
    </style>
</head>
<body>
    ...
    <section class="spot-hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">The Hidden Figure-Eight Cascade of San Jose del Monte</p>
        </div>
    </section>
        ...
        <div class="spot-content">
            <div class="spot-details">
                <div>
                    ...
                    <p class="description">
                        Otso-Otso Falls is a breathtaking hidden gem tucked deep within the forests of San Jose del Monte,
                        named for its distinctive figure-eight shape formed by twin cascades merging into a single
                        crystal-clear natural pool. This destination is part of the iconic Trio Falls tour
                        (Burong, Otso-Otso, and Kaytitinga Falls) with a mandatory tour guide fee of PHP 350
                        per group (max 5 pax), arranged through the tourism office.
                    </p>
                    ...
                    <div class="safety-notice">
                        ...
                        <p style="margin: 0; color: #5d4037; font-size: 0.95rem;">
                            This trail requires moderate to advanced hiking experience. A certified local guide is mandatory
                            for all visitors. Please ensure proper preparation and equipment before attempting this hike,
                            especially during or after rainy season.
                        </p>
                    </div>

                    <h3 class="section-subtitle">Trail Specifications</h3>
                    <ul class="features-list">
                        <li><strong>Total Trail Length:</strong> 4-6 hours round trip covering approximately 6 kilometers</li>
                        <li><strong>Elevation Gain:</strong> 320 meters from trailhead to the falls</li>
                        <li><strong>Terrain Type:</strong> Forest paths, steep sections, and 2 river crossings</li>
                    ...
                    <div class="photo-gallery">
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1509316785289-025f5b846b35?q=80&w=2076&auto=format&fit=crop" alt="Otso-Otso Falls Cascade">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=2070&auto=format&fit=crop" alt="Forest Trail">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1511884642898-4c92249e20b6?q=80&w=2070&auto=format&fit=crop" alt="Natural Pool">
                        </div>
                    </div>
                </div>
                ...
                <div class="spot-info-card">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">Moderate - Challenging</span>
                            </div>
                        </div>
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">320 MASL</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="difficulty-indicator">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            ...
                            <span style="color: #f57c00; font-weight: 600;">Advanced Level</span>
                        </div>
                    ...
                    <button class="btn-primary" onclick="checkAuth('Otso-Otso Falls'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)" style="width: 100%; margin-top: 25px; color: var(--secondary); background-color: var(--primary);">
            ...
            <div class="cta-section">
                <h2 class="cta-title">Ready to Discover the Figure-Eight Falls?</h2>
                <p class="cta-text">
                    Experience the unique twin-cascade beauty of Otso-Otso Falls. Our certified mountain guides
                    will lead you safely through the forest trails to this stunning hidden waterfall.
                </p>
                <div class="cta-buttons">
                    <button class="btn-primary" onclick="checkAuth('Otso-Otso Falls'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)">
                        Book Expedition
                    </button>
