...
$assignedGuide = initializeAssignedGuide("City Oval & People's Park");

if (isset($_GET['action']) && $_GET['action'] === 'book') {
    $destination = $_GET['destination'] ?? "City Oval & People's Park";
...
<body>
    ...
    <section class="spot-hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">The Heart of San Jose del Monte's Community Life</p>
        </div>
    </section>
        ...
        <div class="spot-content">
            <div class="spot-details">
                ...
                <div>
                    ...
                    <p class="description">
                        The City Oval and People's Park is the central recreational hub of San Jose del Monte, 
                        Bulacan — a beautifully maintained public space where residents and visitors gather for 
                        sports, leisure, community events, and weekend relaxation.
                    </p>
                    <p class="description">
                        Surrounded by lush greenery and featuring well-maintained open spaces, the park is a 
                        vibrant venue that hosts city celebrations, cultural events, and daily fitness activities. 
                        It's a perfect family-friendly destination accessible to everyone.
                    </p>

                    <h3 class="section-subtitle">Park Highlights</h3>
                    <ul class="features-list">
                        <li><strong>Running Track:</strong> Well-maintained oval track for jogging and walking</li>
                        <li><strong>Sports Facilities:</strong> Courts and fields for various sports activities</li>
                        <li><strong>Children's Playground:</strong> Safe and fun play areas for kids</li>
                        <li><strong>Open Green Spaces:</strong> Ideal for picnics, yoga, and group activities</li>
                        <li><strong>Community Events:</strong> Regular city festivals, concerts, and gatherings</li>
                        <li><strong>Easy Access:</strong> Centrally located and accessible by public transport</li>
                    </ul>

                    <h3 class="section-subtitle">Gallery</h3>
                    <div class="photo-gallery">
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1519331379826-f10be5486c6f?q=80&w=2070&auto=format&fit=crop" alt="City Park">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=2070&auto=format&fit=crop" alt="Park Grounds">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1501854140801-50d01698950b?q=80&w=2070&auto=format&fit=crop" alt="Open Spaces">
                        </div>
                    </div>
                </div>
                ...
                <div class="spot-info-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">5:00 AM - 9:00 PM</span>
                            </div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">Families, All Ages</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul style="margin: 15px 0; padding-left: 20px; color: var(--text-light); font-size: 0.95rem;">
                        <li>Comfortable walking or sports shoes</li>
                        <li>Water bottle to stay hydrated</li>
                        <li>Picnic mat and snacks</li>
                        <li>Sports equipment if needed</li>
                        <li>Sun protection on sunny days</li>
                    </ul>
                    ...
                    <button class="btn-primary" onclick="checkAuth('City Oval &amp; People\\'s Park'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)" style="width: 100%; margin-top: 25px;">
            ...
            <div class="cta-section">
                <h2 class="cta-title">Visit the Heart of SJDM!</h2>
                <p class="cta-text">
                    Whether you're looking to jog, picnic, play sports, or simply enjoy a day outdoors, 
                    City Oval & People's Park is the perfect destination for everyone.
                </p>
                <div class="cta-buttons">
                    <button class="btn-primary" onclick="checkAuth('City Oval &amp; People\\'s Park'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)">Book a Visit</button>
