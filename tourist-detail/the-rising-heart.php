...
$assignedGuide = initializeAssignedGuide('The Rising Heart Monument');
...
if (isset($_GET['action']) && $_GET['action'] === 'book') {
    $destination = $_GET['destination'] ?? 'The Rising Heart Monument';
    ...
    <style>
        ...
        .spot-hero {
            ...
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.5)), 
                       url('https://images.unsplash.com/photo-1516280077744-01386822c9c6?q=80&w=2070&auto=format&fit=crop');
...
<body>
    ...
    <section class="spot-hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">A Symbol of Love, Unity, and Community Spirit</p>
        </div>
    </section>
        ...
        <div class="spot-content">
            <div class="spot-details">
                ...
                <div>
                    ...
                    <p class="description">
                        The Rising Heart Monument stands as a magnificent landmark in San Jose del Monte, 
                        representing the city's commitment to love, unity, and community development. 
                        This striking monument serves as a gathering place for residents and visitors alike, 
                        symbolizing the collective spirit and aspirations of the SJDM community.
                    </p>
                    
                    <h3 class="section-subtitle">Monument Features</h3>
                    <ul class="features-list">
                        <li><strong>Iconic Design:</strong> Modern architectural masterpiece with heart-inspired elements</li>
                        <li><strong>Community Plaza:</strong> Spacious open area for public gatherings and events</li>
                        <li><strong>Lighting Display:</strong> Spectacular LED lighting shows during special occasions</li>
                        <li><strong>Historical Markers:</strong> Informational plaques detailing SJDM's rich history</li>
                        <li><strong>Photo Opportunities:</strong> Perfect backdrop for memorable photographs</li>
                        <li><strong>Event Venue:</strong> Hosts city celebrations, concerts, and cultural events</li>
                        <li><strong>Accessibility:</strong> Wheelchair accessible with ample parking space</li>
                    </ul>
                    ...
                    <div class="photo-gallery">
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1516280077744-01386822c9c6?q=80&w=2070&auto=format&fit=crop" alt="Monument Day View">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1514565131-fce0801e5785?q=80&w=2070&auto=format&fit=crop" alt="Night Lighting">
                        </div>
                        <div class="gallery-item">
                            <img src="https://images.unsplash.com/photo-1520637836862-4d197d17c9a6?q=80&w=2070&auto=format&fit=crop" alt="Community Event">
                        </div>
                    </div>
                </div>
                ...
                <div class="spot-info-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">24 Hours Daily</span>
                            </div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">30-60 Minutes</span>
                            </div>
                        </div>
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                ...
                                <span class="info-value">SJDM City Center</span>
                            </div>
                        </div>
                    </div>

                    <h3 class="section-subtitle">Best Times to Visit</h3>
                    <ul style="margin: 15px 0; padding-left: 20px; color: var(--text-light); font-size: 0.95rem;">
                        <li><strong>Early Morning:</strong> 6:00 AM - 8:00 AM for peaceful visits</li>
                        <li><strong>Golden Hour:</strong> 5:00 PM - 6:00 PM for photography</li>
                        <li><strong>Evening:</strong> 7:00 PM - 9:00 PM for lighting displays</li>
                        <li><strong>Weekends:</strong> Community events and activities</li>
                    </ul>
                    ...
                    <ul style="margin: 15px 0; padding-left: 20px; color: var(--text-light); font-size: 0.95rem;">
                        ...
                        <li>Sun protection for daytime visits</li>
                        <li>Light jacket for evening visits</li>
                        <li>Water bottle</li>
                    </ul>
                    ...
                    <button class="btn-primary" onclick="checkAuth('The Rising Heart Monument'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)" style="width: 100%; margin-top: 25px; color: var(--secondary); background-color: var(--primary);">
            ...
            <div class="cta-section">
                <h2 class="cta-title">Experience the Heart of SJDM</h2>
                <p class="cta-text">
                    Visit The Rising Heart Monument and discover the symbol of our city's unity and spirit. 
                    Perfect for photography, cultural events, and understanding the essence of San Jose del Monte.
                </p>
                <div class="cta-buttons">
                    <button class="btn-primary" onclick="checkAuth('The Rising Heart Monument'<?php if ($assignedGuide): ?>, '<?php echo $assignedGuide['id']; ?>'<?php endif; ?>)">
                        Book Visit
                    </button>
