<?php
/**
 * Script to set ALL tour guide availability to available except current date
 * This includes weekends, past dates, and all future dates
 */

require_once __DIR__ . '/config/database.php';

echo "Setting ALL tour guide availability to available (except current date)...\n";
...
try {
    ...
    echo "\nALL dates are now available except today!\n";
