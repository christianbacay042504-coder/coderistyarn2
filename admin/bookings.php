        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="bookings.php" class="nav-item active">
                    ...
                    <span>Bookings</span>
                    <?php if ($stats['totalBookings'] > 0): ?>
                        <span class="badge"><?php echo $stats['totalBookings']; ?></span>
                    <?php endif; ?>
                </a>
        ...
        <main class="main-content">
            <header class="top-bar">
                <div class="page-title">
                    ...
                    <p>Manage tour bookings and reservations</p>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn-icon" onclick="viewBooking(<?php echo $booking['id']; ?>)" title="View">
                                            <span class="material-icons-outlined">visibility</span>
                                        </button>
                                        <button class="btn-icon" onclick="editBooking(<?php echo $booking['id']; ?>)" title="Edit">
                                            <span class="material-icons-outlined">edit</span>
                                        </button>
                                        <button class="btn-icon" onclick="updateStatus(<?php echo $booking['id']; ?>)" title="Update Status">
                                            <span class="material-icons-outlined">sync</span>
                                        </button>
                                        <button class="btn-icon" onclick="deleteBooking(<?php echo $booking['id']; ?>)" title="Delete">
